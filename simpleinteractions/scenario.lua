...
Citizen.CreateThread(function()
    ...
    WarMenu.CreateMenu('list', "Animation Menu")
    WarMenu.SetSubTitle('list', 'Animation Menu')
    ...
    WarMenu.CreateSubMenu('sit', 'anims', 'Sitzen') --Sitzen
	WarMenu.CreateSubMenu('dance', 'anims', 'Tanzen') --Tanzen
	WarMenu.CreateSubMenu('inter', 'anims', 'Interaction') --Interaction
	WarMenu.CreateSubMenu('lie', 'anims', 'Liegen') --Liegen
    ...
    while true do
        ...
        elseif WarMenu.IsMenuOpened('anims') then
			...
			elseif WarMenu.MenuButton('Sitzen', 'sit') then
			elseif WarMenu.MenuButton('Liegen', 'lie') then
			elseif WarMenu.MenuButton('Tanzen', 'dance') then
			elseif WarMenu.MenuButton('Interaction', 'inter') then
            end
        ...
        elseif WarMenu.IsMenuOpened('sit') then
            ...
            for theId,theItems in pairs(anims) do
                if theItems.category == "Sitzen" then
                    if WarMenu.Button(theItems.label) then
                        TaskPlayAnim(ped, theItems.dic, theItems.anim, 8.0, -1, -1, looped, 1, 0, 0, 0)
                        PlayingAnim = true
                    end
			...
			WarMenu.Display()
        elseif WarMenu.IsMenuOpened('lie') then
            ...
            for theId,theItems in pairs(anims) do
                if theItems.category == "Liegen" then
                    if WarMenu.Button(theItems.label) then
                        TaskPlayAnim(ped, theItems.dic, theItems.anim, 8.0, -1, -1, looped, 1, 0, 0, 0)
                        PlayingAnim = true
                    end
        ...
        elseif WarMenu.IsMenuOpened('dance') then
            ...
            for theId,theItems in pairs(anims) do
                if theItems.category == "Tanzen" then
                    if WarMenu.Button(theItems.label) then
                        TaskPlayAnim(ped, theItems.dic, theItems.anim, 8.0, -1, -1, looped, 1, 0, 0, 0)
                        PlayingAnim = true
                    end
			...
			WarMenu.Display()
        elseif WarMenu.IsMenuOpened('inter') then
            ...
            for theId,theItems in pairs(anims) do
                if theItems.category == "Interaction" then
                    if WarMenu.Button(theItems.label) then
                        TaskPlayAnim(ped, theItems.dic, theItems.anim, 8.0, -1, -1, looped, 1, 0, 0, 0)
                        PlayingAnim = true
                    end
